...
INSERT INTO `product` (`pid`, `pname`, `tipe`, `category`, `subcategory`, `status`, `pimage`) VALUES
(54, 'hh', 'baranghilang', 'elektronik', 'h', 'hilang', ''),
(55, 'wisnu', 'baranghilang', 'document', 'buku', 'hilang', ''),
(56, 'wisnu', 'baranghilang', 'document', 'buku', 'hilang', '');
