    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Tambahkan Barang</h4>
                    </div>
                    <div class="content">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="tipe" required>
                                            <option value="baranghilang">BarangHilang</option>
                                            <option value="barangtemuan">BarangTemuan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" required name="pimage">
                                    </div>
                                </div>
                            </div>                             
